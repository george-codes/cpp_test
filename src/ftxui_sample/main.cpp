...
// configuration step. It creates a namespace called `cpp_test`. You can modify
...
{
  try {
    CLI::App app{ fmt::format("{} version {}", cpp_test::cmake::project_name, cpp_test::cmake::project_version) };
    ...
    if (show_version) {
      fmt::print("{}\n", cpp_test::cmake::project_version);
      return EXIT_SUCCESS;
    }
